    ...
    <main className="bg-white">
      <div className="w-full ">
        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-background bg-white grid-cols-2 mx-auto">
          <span className="pointer-events-none z-20  whitespace-pre-wrap  bg-clip-text text-center text-7xl font-bold leading-none tracking-tighter text-transparent mb-10">
            ...
            <span className="font-playwrite tracking-tight italic text-3xl font-semibold text-black">Your homeaway from home </span>
            <br/>
            <span className="font-playwrite tracking-tight italic text-3xl font-semibold text-black">One stop solution for finding PG's in Mumbai</span>
      ...
      return(
        <AccordionItem key={index} value={`item-${index + 1}`}>
          <><AccordionTrigger className="text-left text-black">{faq.qs}</AccordionTrigger>
